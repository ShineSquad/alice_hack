...
class Chatbase {
  ...
  * @param $session_id  - Define your own custom sessions
  * @param $version     - Versions of your code
  ...
  * @return Array $request_data - Array containing parameters required by API endpoint
  */
  public function agentMessage($user_id, $platform, $message = "", $session_id = "", $version = "") {
    $request_data = array(
      'api_key' => $this->API_KEY,
      'time_stamp' => $this->getMilliseconds(),
      'type' => 'agent',
